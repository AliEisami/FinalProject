...
class BoardPageTest(unittest.TestCase):
    ...
    def test_delete_board_successful(self):
        ...
        WebDriverWait(self.driver, 5).until(EC.url_contains(self.config['username']))
    ...
    def test_move_list(self):
        ...
        WebDriverWait(self.driver, 5).until(lambda driver: lists[1].text == "To Do")
    ...
    def test_add_card(self):
        ...
        WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.XPATH, self.board_page.ADDED_CARD)))
        self.assertTrue(self.driver.find_element(By.XPATH, self.board_page.ADDED_CARD).is_displayed())
